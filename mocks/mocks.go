...
func (m *PolicyProcessor) GetNotificationSubscriptionOptions(ctx context.Context, k string) (*dispatch.NotificationSubscriptionOptions, error) {
	args := m.Called(ctx, k)

	return args.Get(0).(*dispatch.NotificationSubscriptionOptions), args.Error(1)
}
...
func (m *Dispatcher) Subscribe(address string, subTypes []string, monitoring bool, options *dispatch.NotificationSubscriptionOptions) (dispatch.Subscriber, error) {
